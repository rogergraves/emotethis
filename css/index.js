...
var App = Ext.apply(new Ext.util.Observable,{
	...
	bootstrap: function() {
		var self = this;
		preload(self.preloadImages,function(){
...
//			html: '<div id="main_face_desc_area" style="font-weight: bold;font-size: 20px;text-align: center;">AMAZING</div><div id="main_face_area"><div id="face_area"></div><div id="face_shadow"></div></div>',
			html: '<div id="emotion-stimulus"><div class="stimulus-short">Tell us how you felt about your most recent experience with <span class="bold-text">service at Starbucks</span>.</div>'+
			'<div id="face-name"><div style="color: red;font-size: 12px;">Move finger around light blue area to search for emoticon that best reflects your experience.</div></div></div>' + 
			'<div class="face-area-bg"><div id="minus"><img src="../images/minus.png"></div><div id="face-area"></div><div id="plus"><img src="../images/plus.png"></div>'+
...
App.Ui.IntensityPage = Ext.extend(Ext.Panel, {
	...
	initComponent: function() {
		...
		var config = {
			fullscreen: true,
			layout: 'card',
//			html: '<div id="intensity-stimulus"><div class="stimulus-short">Just how [EMOTION] did the [SHORT DESCRIPTION] make you feel?</div><div id="iface-name">AMAZING</div></div><div id="intensity-big-area" class="face-area-bg"><div id="intensity-area"></div><div class="face-shadow"></div></div><div id="intensity-bg2"></div>',
			html: '<div id="intensity-stimulus"><div class="stimulus-short">Just how <span id="iface-name-title">amazing</span>' + 
				' did the <span class="bold-text">service at Starbucks</span> make you feel?</div>' + 
				'<div id="iface-name"><div style="color: red;font-size: 12px;">Move finger up and down near emoticon to set intensity.</div></div></div><div id="intensity-big-area" class="face-area-bg"><div id="intensity-area"></div><div class="face-shadow"></div></div><div id="intensity-bg2"></div>',
			dockedItems: [
			              toolBar
			]
		};
