...
App.Ui.VerbatimPage = Ext.extend(Ext.Panel, {
	initComponent: function() {
		...
		var config = {
			...
			cls: 'stimulus-bg',
			activeItem: 0, // make sure the active item is set on the container config!
			html: '<div style="overflow:hidden;"><div id="verbatim-title">Why did you feel <span class="bold-text short-stimulus-place-big"></span> about <span id="emotion-name-place"></span>?</div>' + 
			'<div id="verbatim-image-place"><img id="verbatim-image" src=""></div></div><div class="clear_both"></div>' +
