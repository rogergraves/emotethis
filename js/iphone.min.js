...
App.Ui.ThanksPage = Ext.extend(Ext.Panel, {
	...
	,afterRender: function() {
		...
		var emoteId = App.ui.emotePage.faceCol + '_' + App.ui.emotePage.faceRow;
		var faceName = App.ui.emotePage.faceNames[emoteId];
		//var intensity_level = App.ui.intensityPage.intensity_level;
		var verbatim_text = Ext.get('verbatim-textarea').dom.value;
		
		var social_text = "Check out my latest e.mote™ about \"" + App.surveyData.short_stimulus + "\"...   I was " + 
		...
		var fileName = 'amazed_intensity_1';
		
		this.mon(Ext.get('facebook_url'), {
		    tap: function(){
			alert("Tap");
		    	FB.ui({ method: 'feed',
