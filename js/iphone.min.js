...
App.Ui = Ext.extend(Ext.Container, {
	...
	initComponent: function() {
		...
		if(App.surveyDisabled){
			var disabledPage = new App.Ui.DisabledSurveyPage;
			pages = [
			         disabledPage
			];
		}else{
...
App.Ui.DisabledSurveyPage = Ext.extend(Ext.Panel, {
	initComponent: function() {
	
		var toolBar = new App.Ui.StimulusToolbar();

		var config = {
			title: 'e.mote&#0153; unavailable',
			layout:'card',
			fullscreen: true,
			cls: 'stimulus-bg',
			activeItem: 0, // make sure the active item is set on the container config!
			html: '<div style="text-align: center;color: white;padding-top: 10%;font-family: Verdana, Arial, Helvetica, sans-serif;">' +
					'The e.mote&#0153;  you are <br/>attempting to access is <br/>currently unavailable.' +
					'</div>',
		...
		Ext.apply(this, config);
		App.Ui.DisabledSurveyPage.superclass.initComponent.call(this);
	}
});
Ext.reg('App.Ui.DisabledSurveyPage', App.Ui.DisabledSurveyPage);
